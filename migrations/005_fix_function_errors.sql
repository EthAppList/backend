-- Fix Function Errors Migration (idempotent)
-- This migration fixes the get_top_products_by_period function parameter and column issues

-- Drop and recreate the function with proper parameter handling (idempotent)
